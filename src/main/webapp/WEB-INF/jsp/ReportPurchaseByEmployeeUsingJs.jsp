...
<script src='http://localhost:8080/js/purchase.js'></script>
<html>
<head><style> 
.select {
...
<center>
<div class='button'>Purchase Report Employee Wise Product Wise</div><br><br>
 
<table cellspacing='20'>
<tr><td><b><i>Select Employee:</i></b></td>
<td><select class='select' name="employeeid" id='purchaseby'></select></td>
