...
<script src='http://localhost:8080/js/productissue.js'></script>
<html>
<head>
<style> 
.select {
...
<center>
<div class='button'>Issue Report Product Wise Employee Wise</div><br><br>
 
<table cellspacing='20'>
<tr><td><b><i>Select Product:</i></b></td>
<td><select class='select' name="productid" id='issueto'></select></td>
